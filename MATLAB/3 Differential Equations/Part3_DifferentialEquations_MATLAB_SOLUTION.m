...
% results using Euler
ee_res = ts_simulate_SOLUTION(y0, T, n, @ts_ee_1step_SOLUTION);
% results using Runge
rg_res = ts_simulate_SOLUTION(y0, T, n, @ts_runge_1step_SOLUTION);
...
hold on
plot(x, ee_res, DisplayName = "Explicit Euler", LineWidth = 1, Color = "blue", Marker = "o", MarkerSize = 5)
plot(x, rg_res, DisplayName = "Runge", LineWidth = 1, Color = "#007700", Marker = "^", MarkerSize = 5)
