...
results = twogoods_simulate_SOLUTION(p, A, T, delta, @twogoods_cn_SOLUTION);
...
% same!
results_ee = twogoods_simulate_SOLUTION(y0, A, T, delta, @twogoods_ee_SOLUTION);
results_ie = twogoods_simulate_SOLUTION(y0, A, T, delta, @twogoods_ie_SOLUTION);
results_rg = twogoods_simulate_SOLUTION(y0, A, T, delta, @twogoods_runge_SOLUTION);
results_cn = twogoods_simulate_SOLUTION(y0, A, T, delta, @twogoods_cn_SOLUTION);
...
fig = figure(Position = [200 200 560 560]);
title(["Comparison of timestepping schemes", "in terms of accuracy"])

hold on
plot(results_ee(1, :), results_ee(2, :), Color = "blue", LineWidth = 1, DisplayName = "Explicit Euler")
plot(results_ie(1, :), results_ie(2, :), Color = "red", LineWidth = 1, DisplayName = "Implicit Euler")
plot(results_cn(1, :), results_cn(2, :), Color = "black", LineWidth = 1, DisplayName = "Crank-Nicolson")
hold off
